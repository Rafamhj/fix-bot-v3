...
global.sfb = 'https://www.facebook.com/zubair.mahajanu' // facebook
...
/*============== NOMOR ==============*/
global.nomorbot = '6282250614733'
global.nomorown = '6285244437857'
global.namebot = 'RAFA-MAHAJANU'
global.nameown = 'RAFA MAHAJANU'

/*============== Github Thanks To ==============*/
global.namagithub = 'Rafamhj' // nama github lu
global.linkgithub = 'https://github.com/Rafamhj' // tarok link github lu
...
/*============== STAFF ==============*/
global.owner = [
  ['6285244437857', 'RAFA MAHAJANU', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true],
  ['-', 'ISI KALAU ADA', true]
